...
// Styling using HOC component withStyles for majority of components
const styles = theme => ({
    avatar: {
        margin: 10,
...
class Profile extends Component {
    ...
    // Fetching the API data for respective Endpoints
    componentWillMount() {
        let data = null;
    ...
    // Update functionality for Fav Edit Icon button
    ...
    // Getting the post uniquely for Each id on opening the modal
    ...
    // Implementing the functionality for Like Count unique for each post
    iconClickHandler = (e) => {
    ...
    // Implementing the functionality to add Comments unique for each post
    commentClickHandler = () => {
    ...
    render() {
        ...
        return (
            <div>
                ...
                {/* Information Section Container having the required fields - profile picture, user name, followedby,
        follows, Full name and editIcon */}
                ...
                {/* Container to display all the posts as a Grid List */}
                <div className="posts-flex-container">
                    ...
                    {/* Modal to display each post with relevant information - likes, comments, username, profile 
                    picture,tags & text fetched from the API endpoint*/}
